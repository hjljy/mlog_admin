<template>
  <div class="home-container">
    <el-row :gutter="15">
          ...
          <div class="flex-margin flex">
            ...
            <div class="home-card-first-right ml15">
              <div class="flex-margin">
                ...
                <div class="home-card-first-right-msg mt5">{{ getUserInfos.userType === 'ADMIN' ? '超级管理员' : '普通用户' }}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <el-col :sm="3"
              class="mb15">
        <div class="home-card-item home-card-item-box"
             style="background:#F95959 ">
          <div class="home-card-item-flex">
            <div class="home-card-item-title pb3">今日访问数</div>
            <div class="home-card-item-title-num pb6">{{ statisticsCount.view }}</div>
          </div>
          <i class="fa fa-eye"
      ...
      <el-col :sm="3"
              class="mb15">
        <div class="home-card-item home-card-item-box"
             style="background:#FEBB50 ">
          <div class="home-card-item-flex">
            <div class="home-card-item-title pb3">文章总数</div>
            <div class="home-card-item-title-num pb6">{{ statisticsCount.article }}</div>
          </div>
          <i class="iconfont icon-fuwenbenkuang"
             style="color: #FDC566"></i>
        </div>
      </el-col>
      <el-col :sm="3"
              class="mb15">
        <div class="home-card-item home-card-item-box"
          ...
          <div class="home-card-item-flex">
            <div class="home-card-item-title pb3">评论总数</div>
            <div class="home-card-item-title-num pb6">{{ statisticsCount.comment }}</div>
          </div>
          <SvgIcon name="elementChatDotRound"
                   style="color:#55aaff" />
      ...
      <el-col :sm="3"
        ...
        <div class="home-card-item home-card-item-box"
             style="background:#FEBB50 ">
          <div class="home-card-item-flex">
            <div class="home-card-item-title pb3">友链总数</div>
            <div class="home-card-item-title-num pb6">{{ statisticsCount.links }}</div>
          </div>
          <i class="iconfont icon-shenqingkaiban"
             style="color: #FDC566"></i>
        </div>
      </el-col>
    </el-row>
    <el-row :gutter="15">
      <el-col :xs="24"
        ...
        <el-card shadow="hover"
                 :header="$t('message.card.title1')">
          <div style="height: 200px"
               ref="homeLaboratoryRef"></div>
        </el-card>
      </el-col>
      <el-col :xs="24"
              :sm="10"
              ...
              :xl="8">
        <el-card shadow="hover"
                 :header="$t('message.card.title2')">
          <div class="home-monitor">
            <div class="flex-warp">
              <div class="flex-warp-item"
                   v-for="(v, k) in environmentList"
                   :key="k">
                <div class="flex-warp-item-box">
                  <i :class="v.icon"
                     :style="{ color: v.iconColor }"></i>
        ...
        <el-card shadow="hover"
          ...
          <el-table :data="tableData.data"
            ...
            <el-table-column prop="date"
                             :label="$t('message.table.th1')"></el-table-column>
            <el-table-column prop="name"
                             :label="$t('message.table.th2')"></el-table-column>
            <el-table-column prop="address"
                             :label="$t('message.table.th3')"></el-table-column>
          </el-table>
        </el-card>
      </el-col>
      <el-col :xs="24"
              ...
              :lg="8"
              :xl="8"
              class="home-dynamic-media">
        <el-card shadow="hover"
                 :header="$t('message.card.title4')">
          <div class="home-dynamic">
            <el-scrollbar>
              <div class="home-dynamic-item"
                   v-for="(v, k) in activitiesList"
                   :key="k">
    ...
    <el-row>
      <el-col :xs="24"
              ...
              class="mt15">
        <el-card shadow="hover"
                 :header="$t('message.card.title5')">
          <div style="height: 200px"
               ref="homeOvertimeRef"></div>
        </el-card>
      </el-col>
    </el-row>
  </div>
...
import { environmentList, activitiesList } from './mock';
import { statisticsCount } from '/@/api/statistics';
export default {
	name: 'home',
	setup() {
		...
		// 页面加载时
		onMounted(async () => {
			state.statisticsCount = (await statisticsCount()).data;
			initNumCountUp();
			initHomeLaboratory();
			initHomeOvertime();
			initEchartsResize();
