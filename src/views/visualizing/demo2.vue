    ...
    <div class="big-data-up">
      ...
      <div class="up-right">
        <el-dropdown size="small">
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item v-for="(v, k) in dropdownList"
                                :key="k">{{ v.label }} </el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
        <div class="ml15">
          <SvgIcon name="elementBell"
                   class="mr5" />
          <span>消息</span>
        </div>
        <div class="ml15">
          <SvgIcon name="elementUser"
                   class="mr5" />
          <span>个人</span>
        </div>
        <div class="ml15">
          ...
          <div class="flex-warp-item-box">
            ...
            <div class="flex-content flex-content-overflow">
              <div class="d-states">
                ...
                <div class="d-states-item">
                  <SvgIcon name="elementFirstAidKit"
                           class="i-bg2" />
                  <div class="d-states-flex">
